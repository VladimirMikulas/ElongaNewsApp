...
class ComposeAndNetworkExampleInstrumentedTest {
    ...
    private lateinit var scenario: ActivityScenario<com.vlamik.nba.MainActivity>
    ...
    fun setUp() {
        hiltRule.inject()
        scenario = ActivityScenario.launch(com.vlamik.nba.MainActivity::class.java)
    ...
    fun listPlayersSuccess() {
        ...
        with(composeRule) {
             ...
             */
            onNodeWithText(
                instrumentationContext.getString(R.string.player_list),
    ...
    fun listPlayersError() {
        ...
        with(composeRule) {
            waitForIdle()
            onNodeWithText(instrumentationContext.getString(R.string.player_list))
                .assertDoesNotExist()
        }
    }
}
